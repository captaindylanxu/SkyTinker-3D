export const LOCALES = {
  'zh-CN': {
    ...
    account: {
      ...
      firstGameComplete: '首次飞行完成！',
      createAccountPrompt: '创建账号保存你的成绩，参与全球排行榜',
      createNew: '创建新账号',
      recoverAccount: '找回账号',
      skip: '跳过',
      continue: '继续',
    ...
    share: {
      ...
      wechatGuide: '📋 分享内容已复制到剪贴板\n请点击右上角「 ··· 」分享给微信好友',
      wechatTapGuide: '点击右上角「 ··· 」\n选择「发送给朋友」\n💡 分享文案已复制，可长按粘贴到消息框',
      tapToDismiss: '点击任意位置关闭',
  ...
  'zh-TW': {
    ...
    account: {
      ...
      firstGameComplete: '首次飛行完成！',
      createAccountPrompt: '創建帳號保存你的成績，參與全球排行榜',
      createNew: '創建新帳號',
      recoverAccount: '找回帳號',
      skip: '跳過',
      continue: '繼續',
    ...
    share: {
      ...
      wechatGuide: '📋 分享內容已複製到剪貼簿\n請點擊右上角「 ··· 」分享給微信好友',
      wechatTapGuide: '點擊右上角「 ··· 」\n選擇「傳送給朋友」\n💡 分享文案已複製，可長按貼上到訊息框',
      tapToDismiss: '點擊任意位置關閉',
  ...
  'en': {
    ...
    account: {
      ...
      firstGameComplete: 'First Flight Complete!',
      createAccountPrompt: 'Create an account to save your score and join the global leaderboard',
    ...
    share: {
      ...
      wechatGuide: '📋 Share content copied to clipboard\nTap the ··· button in the top right to share with WeChat friends',
      wechatTapGuide: 'Tap ··· in the top right\nand choose "Send to Friends"\n💡 Message copied — long press to paste',
  ...
  'ja': {
    ...
    account: {
      ...
      firstGameComplete: '初フライト完了！',
      createAccountPrompt: 'アカウントを作成してスコアを保存し、グローバルランキングに参加',
      createNew: '新規アカウント作成',
    ...
    share: {
      ...
      wechatGuide: '📋 シェア内容をクリップボードにコピーしました\n右上の「···」をタップしてWeChatの友達にシェア',
      wechatTapGuide: '右上の「···」をタップして\n「友達に送信」を選択\n💡 メッセージはコピー済み、長押しで貼り付け',
  ...
  'ko': {
    ...
    account: {
      ...
      firstGameComplete: '첫 비행 완료!',
      createAccountPrompt: '계정을 만들어 점수를 저장하고 글로벌 순위표에 참여하세요',
      createNew: '새 계정 만들기',
    ...
    share: {
      ...
      wechatGuide: '📋 공유 내용이 클립보드에 복사되었습니다\n오른쪽 상단 「···」을 탭하여 WeChat 친구에게 공유',
      wechatTapGuide: '오른쪽 상단 「···」을 탭하고\n「친구에게 보내기」를 선택\n💡 메시지가 복사되었습니다. 길게 눌러 붙여넣기',
      tapToDismiss: '아무 곳이나 탭하여 닫기',
  ...
  'de': {
    ...
    account: {
      ...
      firstGameComplete: 'Erster Flug abgeschlossen!',
      createAccountPrompt: 'Erstellen Sie ein Konto, um Ihren Punktestand zu speichern und an der globalen Rangliste teilzunehmen',
    ...
    share: {
      ...
      wechatGuide: '📋 Inhalt in die Zwischenablage kopiert\nTippe oben rechts auf ··· um mit WeChat-Freunden zu teilen',
      wechatTapGuide: 'Tippe oben rechts auf ···\nund wähle „An Freunde senden"\n💡 Nachricht kopiert — zum Einfügen lange drücken',
      tapToDismiss: 'Tippe irgendwo zum Schließen',
  ...
  'ru': {
    ...
    account: {
      ...
      firstGameComplete: 'Первый полёт завершён!',
      createAccountPrompt: 'Создайте аккаунт, чтобы сохранить результат и участвовать в глобальном рейтинге',
    ...
    share: {
      ...
      wechatGuide: '📋 Содержимое скопировано в буфер обмена\nНажмите ··· в правом верхнем углу, чтобы поделиться с друзьями в WeChat',
      wechatTapGuide: 'Нажмите ··· в правом верхнем углу\nи выберите «Отправить друзьям»\n💡 Сообщение скопировано — удерживайте для вставки',
  ...
  'fr': {
    ...
    account: {
      ...
      firstGameComplete: 'Premier vol terminé!',
      createAccountPrompt: 'Créez un compte pour sauvegarder votre score et rejoindre le classement mondial',
    ...
    share: {
      ...
      wechatGuide: '📋 Contenu copié dans le presse-papiers\nAppuyez sur ··· en haut à droite pour partager avec vos amis WeChat',
      wechatTapGuide: 'Appuyez sur ··· en haut à droite\net choisissez « Envoyer à des amis »\n💡 Message copié — appuyez longuement pour coller',
